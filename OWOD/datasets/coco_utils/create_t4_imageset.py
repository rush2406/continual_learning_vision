...
# Train
coco_annotation_file = '/homestudent/datasets/mscoco/annotations/instances_train2017.json'
dest_file = '/home/student/OWOD/datasets/coco17_voc_style/ImageSets/t4_train.txt'
...
dest_file = '/home/student/OWOD/datasets/coco17_voc_style/ImageSets/t4_test.txt'
...
dest_file = '/home/student/OWOD/datasets/coco17_voc_style/ImageSets/t4_test_unk.txt'
with open(dest_file, 'w') as file:
    for image_id in image_ids:
        file.write(str(image_id)+'\n')
