...
dest_file = '/home/student/OWOD/datasets/coco17_voc_style/ImageSets/t2_train.txt'
...
dest_file = '/home/student/OWOD/datasets/coco17_voc_style/ImageSets/t2_test.txt'
...
dest_file = '/home/student/OWOD/datasets/coco17_voc_style/ImageSets/t2_test_unk.txt'
with open(dest_file, 'w') as file:
    for image_id in image_ids:
        file.write(str(image_id)+'\n')
