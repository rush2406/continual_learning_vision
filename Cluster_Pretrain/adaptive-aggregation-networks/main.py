...
if __name__ == '__main__':
    ...
    parser.add_argument('--eval_batch_size', default=50, type=int, help='the batch size for validation loader')
    ...
    ### LUCIR parameters
    parser.add_argument('--the_lambda', default=8, type=float, help='lamda for LF')
