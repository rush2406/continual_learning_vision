...
class BaseTrainer(object):
    ...
    def init_current_phase_model(self, iteration, start_iter, b1_model, b2_model):
        ...
        if iteration == start_iter:
            ...
            new_pseudo = modified_linear.SplitCosineLinear(in_features, out_features, self.args.nb_cl)
            ...
            new_pseudo.fc1.weight.data = b1_model.pseudo.weight.data
            new_pseudo.sigma.data = b1_model.pseudo.sigma.data
            b1_model.pseudo = new_pseudo
            ...
            new_pseudo = modified_linear.SplitCosineLinear(in_features, out_features1+out_features2, self.args.nb_cl)
            new_pseudo.fc1.weight.data[:out_features1] = b1_model.pseudo.fc1.weight.data
            new_pseudo.fc1.weight.data[out_features1:] = b1_model.pseudo.fc2.weight.data
            new_pseudo.sigma.data = b1_model.pseudo.sigma.data
            b1_model.pseudo = new_pseudo
            # Update the lambda parameter for the current phase
